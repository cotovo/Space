...
export default function SiteSections() {
  ...
  return (
    <section
      id="content"
      ref={containerRef}
      className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-12 pt-16 md:pt-24 pb-4 md:pb-8 flex flex-col gap-24 md:gap-32"
    >
      {/* About Section */}
      <Reveal>
        <SpotlightCard
          className="grid grid-cols-1 md:grid-cols-12 border border-white/10 bg-white/[0.02] rounded-3xl overflow-hidden shadow-2xl backdrop-blur-md p-0"
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col divide-y divide-white/10">
            ...
            <div className="flex-1 p-6 md:p-8 flex items-center gap-4 hover:bg-[var(--t-signal)]/10 transition-colors cursor-default">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] text-white/40 font-mono uppercase tracking-widest mb-0.5">
                  Focus
                </span>
              ...
              >
                <div className="md:col-span-3 flex flex-row md:flex-col items-center md:items-start justify-between md:justify-center gap-2">
                  ...
                  <ScrambledText
                    radius={50}
                    scrambleChars=".:/*#"
                    className="text-[10px] font-mono text-white/50 tracking-widest uppercase cursor-default"
                  >
                    {project.stack}
                  </ScrambledText>
                </div>
      ...
      <Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-0 relative">
          ...
          {TIMELINE.map((entry) => (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-12 group hover:bg-white/[0.04] transition-colors rounded-2xl p-4 md:p-6 -mx-2 md:-mx-6 border border-transparent hover:border-white/10">
                ...
                <div className="md:col-span-3 flex md:justify-end items-center md:items-start md:pr-12 relative mb-2 md:mb-0">
                  ...
                  <div className="text-sm font-mono font-bold tracking-widest text-[var(--t-signal)]/80 group-hover:text-[var(--t-signal)] transition-colors">
                ...
                <div className="md:col-span-9 md:pl-12 flex flex-col gap-2">
                  ...
                  <div className="text-sm text-white/60 group-hover:text-white/80 transition-colors leading-relaxed max-w-2xl">
